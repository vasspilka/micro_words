...
NPCs
 ...
 We can use a relativy theory for ticks time ticks. For example every 100 user actions is one world time tick





 The ideas required to build the whole platforms are not well thought out yet.

As a suggestions to go past the block I would suggest to document the various paths this project can take in order to analyze discuss and understand how to procceed


 Seems in order to make the idea work fully I need to further design





 Make content creation independant, explorers can have inventory of artefacts
